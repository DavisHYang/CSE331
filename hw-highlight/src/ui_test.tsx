...
describe('ui', function() {
  ...
  it('ShowColorSet', function() {
    assert.deepEqual(
        ShowColorSet({text: 'pretendo', colors: test_color_list}), <div>{[]}</div>);
    assert.deepEqual(
        ShowColorSet({text: 'indigo', colors: test_color_list}),
        <div>{[
    ...
    assert.deepEqual(
        ShowColorSet({text: 'lavender', colors: test_color_list}),
        <div>{[
  ...
  it('ShowHighlights', function() {
    assert.deepEqual(
        ShowHighlights({highlights: explode_array([]), colors: test_color_list}),
        <div>{[]}</div>);
    assert.deepEqual(
        ShowHighlights({highlights: explode_array([
            {color: 'red', text: 'a quick brown'}
          ]), colors: test_color_list}),
        <div>{[
